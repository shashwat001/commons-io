...
public class ReversedLinesFileReaderTestParamSeek
{
    ...
    public ReversedLinesFileReaderTestParamSeek(final String fileName, final String encoding, final Integer buffsize) {
